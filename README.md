...
| onBuildSave          | `(pdfBytes: Uint8Array, buildSchema: BuildModeField[]) => void`, optional        | Receives the designed field schema and PDF in build mode.                                                                                                                                                                                                                                                                                                                                                                                                          |
| fieldAssignments     | `Record<string, string[]>`, optional                                             | Map of field name to participant id(s) to enforce in edit mode. If omitted, all fields are editable.                                                                                                                                                                                                                                                                                                                                                               |
...
<PDFEditor
  ...
  onBuildSave={(pdfBytes, schema) => {
    // Persist the schema with field assignments
